...
export const siteConfig: SiteConfig = {
  ...
  description: "Blog com opiniões pessoais sobre ocultismo, filosofia e psicologia. Criado em 2026 sem uso de inteligência artificial.",
  // [CONFIG:SITE_AUTHOR]
  author: "Jonas",
  ...
  navigation: {
    ...
    social: [
      {
        title: "GitHub",
        url: "https://github.com/jonasslv/pleroma",
        icon: "github",
      },
    ],
  },
